...
- [x] Ship the full Smart TODO daily workflow release: seven-item Today docket with pins, snooze/wake, Restore, new/changed and duplicate review, project drill-down, Copy Context, conservative stale views, and local-only atomic workflow state.
