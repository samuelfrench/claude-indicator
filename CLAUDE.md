...
## Project Description
Translucent PySide6 desktop widget showing Claude Code Max subscription usage limits with color-coded progress bars and countdown timers.

## Architecture
- **Single-file app**: `claude_widget.py` contains all logic (client, UI, timers)
...
- **ClaudeWidget**: Frameless, translucent, always-on-top PySide6 widget with drag support
